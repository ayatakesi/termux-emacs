...
$(info $(LOCAL_EXPORT_LDFLAGS) $(abspath $(addprefix $(NDK_BUILD_DIR)/,$(NDK_A_NAMES))) -L$(abspath $(NDK_BUILD_DIR)) $(foreach soname,$(basename $(NDK_SO_NAMES)),-l:$(soname)))
$(info $(addprefix $(NDK_BUILD_DIR)/,$(NDK_SO_NAMES)))
