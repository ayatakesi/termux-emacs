...
$(info $(LOCAL_EXPORT_LDFLAGS) $(abspath $(addprefix $(NDK_BUILD_DIR)/,$(NDK_A_NAMES))) -L$(abspath $(call my-dir)) $(foreach soname,$(notdir $(NDK_SO_NAMES)),-l:$(soname)))
$(info $(abspath $(addprefix $(dir $(call my-dir))/,$(NDK_SO_NAMES))))
