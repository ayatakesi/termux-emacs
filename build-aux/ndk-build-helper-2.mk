...
$(info $(LOCAL_EXPORT_LDFLAGS) $(abspath $(addprefix $(ANDROID_MODULE_DIRECTORY)/,$(NDK_A_NAMES))) $(and $(NDK_SO_NAMES), -L$(abspath $(ANDROID_MODULE_DIRECTORY)) $(foreach soname,$(NDK_SO_NAMES),-l:$(soname))))
